...
function Profile({ styles, userName, userEmail }: { styles: ReturnType<typeof useStyles>; userName: string; userEmail: string }) { return <><div className={styles.user}><Avatar name={userName} color="brand" size={64} /><div><Title1>{userName}</Title1><Body1 className={styles.muted}>{userEmail}</Body1></div></div><div className={styles.planGrid}><Card className={styles.tableCard}><CardHeader header={<Subtitle2>Account Info</Subtitle2>} image={<Person24Regular />} /><Body2>Name, email, and verification status</Body2><Badge appearance="tint" color="success">✓ Identity verified</Badge></Card><Card className={styles.tableCard}><CardHeader header={<Subtitle2><span style={{ color: '#2495e8' }}>Support Bot</span></Subtitle2>} image={<PeopleTeam24Regular />} /><Subtitle2>24/7 Live Support</Subtitle2><Body2>Get instant help from our support team on Telegram</Body2><Button as="a" href="https://t.me/SAGE_CAPITAL_BOT" target="_blank" rel="noreferrer" appearance="primary">Chat with Bot</Button><Caption1 className={styles.muted}>Average response time: under 5 minutes</Caption1></Card><Card className={styles.tableCard}><CardHeader header={<Subtitle2><span style={{ color: '#2495e8' }}>Community Group</span></Subtitle2>} image={<PeopleTeam24Regular />} /><Subtitle2>Join our Community</Subtitle2><Body2>Connect with other investors and stay updated</Body2><Button as="a" href="https://t.me/+iaDnftGtqgsxZjY8" target="_blank" rel="noreferrer" appearance="outline">Join Telegram Group</Button><Caption1 className={styles.muted}>Official SageCapital Group</Caption1></Card></div></> }
